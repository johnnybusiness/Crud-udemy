...
namespace Gestor.API
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<GestorContext>(options => options.UseSqlServer(Configuration.GetConnectionString("GestorConnection")));

            services.AddControllers();

            services.AddScoped<IGaleriaRepository, SqlGaleriaRepository>();
